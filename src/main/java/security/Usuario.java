...
@Views({
    ...
    roles = "Super,Administrador,Atendente,Medico,Enfermeiro,TecnicoDeEnfermagem,AgenteDeSaude"),
...
public class Usuario implements Serializable, CurrentUser {
    ...
    public enum Papel {
        ...
        Administrador, Atendente, Medico, Enfermeiro, TecnicoDeEnfermagem, AgenteDeSaude
