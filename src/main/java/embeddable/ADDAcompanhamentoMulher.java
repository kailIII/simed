...
public class ADDAcompanhamentoMulher implements Serializable {
    ...
    @ManyToOne
    private AtendimentoAMulher mulherAddAcompanhamento;

    @ActionDescriptor(methodDisabled = "#{not autoEntityBackBean.formInEditMode}")
    public void removerSintoma() {
        mulherAddAcompanhamento.getAddAcompanhamentoMulher().remove(this);
    ...
    public AtendimentoAMulher getMulherAddAcompanhamento() {
        return mulherAddAcompanhamento;
    }

    public void setMulherAddAcompanhamento(AtendimentoAMulher mulherAddAcompanhamento) {
        this.mulherAddAcompanhamento = mulherAddAcompanhamento;
    }
